...
CREATE TABLE IF NOT EXISTS vendas_espaco (
  id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  espaco_id INT UNSIGNED NOT NULL,
  item_espaco_id INT UNSIGNED DEFAULT NULL,
  ...
  CONSTRAINT fk_vendas_item FOREIGN KEY (item_espaco_id) REFERENCES itens_espaco(id) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS transacoes (
  ...
  parcela_pagar_id INT UNSIGNED DEFAULT NULL,
  ...
  CONSTRAINT fk_trans_parcela_pagar FOREIGN KEY (parcela_pagar_id) REFERENCES parcelas_pagar(id) ON DELETE SET NULL ON UPDATE CASCADE,
