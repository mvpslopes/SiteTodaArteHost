...
const PAGES: { match: string | RegExp; meta: PageMeta }[] = [
  ...
  { match: '/clientes', meta: { title: 'Clientes', subtitle: 'Cadastro de clientes da agência' } },
  { match: '/logins', meta: { title: 'Logins', subtitle: 'Senhas de acesso: Instagram, YouTube, e-mail, Facebook e outros' } },
