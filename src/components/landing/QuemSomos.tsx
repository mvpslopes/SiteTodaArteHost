...
export function QuemSomos() {
  ...
  return (
    <>
      {/* Section Header */}
      <section id="quem-somos" className="relative bg-gradient-to-br from-logo-dark via-logo to-logo-light text-white py-12 sm:py-16 md:py-20 lg:py-24 overflow-hidden">
          ...
          <FadeIn delay={0} duration={0.8}>
            <div className="space-y-4 sm:space-y-6 md:space-y-8">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold px-2">
                ...
                <br />
                <span className="text-white drop-shadow-lg">Somos</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 max-w-3xl mx-auto leading-relaxed px-2">
            ...
            {values.map((value, index) => {
              ...
              return (
                <FadeIn key={index} delay={index * 100} duration={0.6}>
                  <div
                    className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 card-hover border border-logo/10"
                  >
