      ...
      {showForm && (
        <form className="bg-white p-6 rounded-xl shadow mb-6 flex flex-wrap gap-4 items-end border border-logo-light/30" onSubmit={handleSubmit}>
          ...
          <div className="flex gap-2 mt-4">
            ...
            <button type="button" className="px-5 py-2 rounded-xl bg-gradient-to-r from-logo to-logo-light text-white hover:brightness-110 border-none" onClick={() => { setShowForm(false); setEditId(null); setForm({ nome: '', email: '', telefone: '', empresa: '', observacoes: '', cpf_cnpj: '' }); }}>Cancelar</button>
          </div>
        </form>
      )}
