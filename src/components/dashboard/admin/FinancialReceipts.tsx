              ...
              {receipts.map((r, i) => (
                <tr key={i} className={i % 2 === 0 ? 'bg-gray-50 hover:bg-blue-50 transition' : 'bg-white hover:bg-blue-50 transition'}>
                  ...
                  <td className="px-6 py-3 text-center">
                    <button className="inline-flex items-center gap-2 bg-gradient-to-r from-logo to-logo-light text-white px-4 py-2 rounded-full shadow hover:brightness-110 transition text-sm font-semibold" onClick={() => gerarReciboPDF(r)}>
